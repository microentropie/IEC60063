...
const char E192Tolerance[] = "0.5%";

#define E192size 192
static const unsigned short E192[E192size + 1] = { 100, 101, 102, 104, 105, 106,
...
float E192Value(float r)
{
  return EserieValue(E192, E192size, r);
}

char *E192FormattedValue(char *buf, int len, float r, char unitTypeChar)
{
  return EserieFormattedValue(buf, len, E192, E192size, r, unitTypeChar);
}
